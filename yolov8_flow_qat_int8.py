...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/jia/PycharmProjects/yolov10/runs/detect/basketball_yolov8s/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--hyp', type=str, default='/home/jia/PycharmProjects/yolov8-pytorch_quantization/cfg/default.yaml', help='hyperparameters path')
...
if __name__ == "__main__":
    ...
    save_path = 'weights/yolov8s_qat_basketball.pt'
    yolo.save(save_path)
    with torch.no_grad():
